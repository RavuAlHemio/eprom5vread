...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioarst(&mut self) -> GPIOARST_W<IOPRSTR_SPEC> {
        GPIOARST_W::new(self, 0)
    }
    #[doc = "Bit 1 - GPIOBRST"]
    #[inline(always)]
    #[must_use]
    pub fn gpiobrst(&mut self) -> GPIOBRST_W<IOPRSTR_SPEC> {
        GPIOBRST_W::new(self, 1)
    }
    #[doc = "Bit 2 - GPIOCRST"]
    #[inline(always)]
    #[must_use]
    pub fn gpiocrst(&mut self) -> GPIOCRST_W<IOPRSTR_SPEC> {
        GPIOCRST_W::new(self, 2)
    }
    #[doc = "Bit 3 - GPIODRST"]
    #[inline(always)]
    #[must_use]
    pub fn gpiodrst(&mut self) -> GPIODRST_W<IOPRSTR_SPEC> {
        GPIODRST_W::new(self, 3)
    }
    #[doc = "Bit 4 - GPIOERST"]
    #[inline(always)]
    #[must_use]
    pub fn gpioerst(&mut self) -> GPIOERST_W<IOPRSTR_SPEC> {
        GPIOERST_W::new(self, 4)
    }
    #[doc = "Bit 5 - GPIOFRST"]
    #[inline(always)]
    #[must_use]
    pub fn gpiofrst(&mut self) -> GPIOFRST_W<IOPRSTR_SPEC> {
