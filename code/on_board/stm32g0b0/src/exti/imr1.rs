...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn im0(&mut self) -> IM0_W<IMR1_SPEC> {
        IM0_W::new(self, 0)
    }
    #[doc = "Bit 1 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im1(&mut self) -> IM1_W<IMR1_SPEC> {
        IM1_W::new(self, 1)
    }
    #[doc = "Bit 2 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im2(&mut self) -> IM2_W<IMR1_SPEC> {
        IM2_W::new(self, 2)
    }
    #[doc = "Bit 3 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im3(&mut self) -> IM3_W<IMR1_SPEC> {
        IM3_W::new(self, 3)
    }
    #[doc = "Bit 4 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im4(&mut self) -> IM4_W<IMR1_SPEC> {
        IM4_W::new(self, 4)
    }
    #[doc = "Bit 5 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im5(&mut self) -> IM5_W<IMR1_SPEC> {
        IM5_W::new(self, 5)
    }
    #[doc = "Bit 6 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im6(&mut self) -> IM6_W<IMR1_SPEC> {
        IM6_W::new(self, 6)
    }
    #[doc = "Bit 7 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im7(&mut self) -> IM7_W<IMR1_SPEC> {
        IM7_W::new(self, 7)
    }
    #[doc = "Bit 8 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im8(&mut self) -> IM8_W<IMR1_SPEC> {
        IM8_W::new(self, 8)
    }
    #[doc = "Bit 9 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im9(&mut self) -> IM9_W<IMR1_SPEC> {
        IM9_W::new(self, 9)
    }
    #[doc = "Bit 10 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im10(&mut self) -> IM10_W<IMR1_SPEC> {
        IM10_W::new(self, 10)
    }
    #[doc = "Bit 11 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im11(&mut self) -> IM11_W<IMR1_SPEC> {
        IM11_W::new(self, 11)
    }
    #[doc = "Bit 12 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im12(&mut self) -> IM12_W<IMR1_SPEC> {
        IM12_W::new(self, 12)
    }
    #[doc = "Bit 13 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im13(&mut self) -> IM13_W<IMR1_SPEC> {
        IM13_W::new(self, 13)
    }
    #[doc = "Bit 14 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im14(&mut self) -> IM14_W<IMR1_SPEC> {
        IM14_W::new(self, 14)
    }
    #[doc = "Bit 15 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im15(&mut self) -> IM15_W<IMR1_SPEC> {
        IM15_W::new(self, 15)
    }
    #[doc = "Bit 19 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im19(&mut self) -> IM19_W<IMR1_SPEC> {
        IM19_W::new(self, 19)
    }
    #[doc = "Bit 21 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im21(&mut self) -> IM21_W<IMR1_SPEC> {
        IM21_W::new(self, 21)
    }
    #[doc = "Bit 22 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im22(&mut self) -> IM22_W<IMR1_SPEC> {
        IM22_W::new(self, 22)
    }
    #[doc = "Bit 23 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im23(&mut self) -> IM23_W<IMR1_SPEC> {
        IM23_W::new(self, 23)
    }
    #[doc = "Bit 24 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im24(&mut self) -> IM24_W<IMR1_SPEC> {
        IM24_W::new(self, 24)
    }
    #[doc = "Bit 25 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im25(&mut self) -> IM25_W<IMR1_SPEC> {
        IM25_W::new(self, 25)
    }
    #[doc = "Bit 26 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im26(&mut self) -> IM26_W<IMR1_SPEC> {
        IM26_W::new(self, 26)
    }
    #[doc = "Bit 31 - CPU wakeup with interrupt mask on event input"]
    #[inline(always)]
    #[must_use]
    pub fn im31(&mut self) -> IM31_W<IMR1_SPEC> {
        IM31_W::new(self, 31)
    }
