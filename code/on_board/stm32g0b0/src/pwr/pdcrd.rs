...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd0(&mut self) -> PD0_W<PDCRD_SPEC> {
        PD0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd1(&mut self) -> PD1_W<PDCRD_SPEC> {
        PD1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd2(&mut self) -> PD2_W<PDCRD_SPEC> {
        PD2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd3(&mut self) -> PD3_W<PDCRD_SPEC> {
        PD3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd4(&mut self) -> PD4_W<PDCRD_SPEC> {
        PD4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd5(&mut self) -> PD5_W<PDCRD_SPEC> {
        PD5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd6(&mut self) -> PD6_W<PDCRD_SPEC> {
        PD6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> PD7_W<PDCRD_SPEC> {
        PD7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd8(&mut self) -> PD8_W<PDCRD_SPEC> {
        PD8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd9(&mut self) -> PD9_W<PDCRD_SPEC> {
        PD9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd10(&mut self) -> PD10_W<PDCRD_SPEC> {
        PD10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd11(&mut self) -> PD11_W<PDCRD_SPEC> {
        PD11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd12(&mut self) -> PD12_W<PDCRD_SPEC> {
        PD12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd13(&mut self) -> PD13_W<PDCRD_SPEC> {
        PD13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd14(&mut self) -> PD14_W<PDCRD_SPEC> {
        PD14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Port D pull-down bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pd15(&mut self) -> PD15_W<PDCRD_SPEC> {
        PD15_W::new(self, 15)
    }
