...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pu0(&mut self) -> PU0_W<PUCRB_SPEC> {
        PU0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu1(&mut self) -> PU1_W<PUCRB_SPEC> {
        PU1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu2(&mut self) -> PU2_W<PUCRB_SPEC> {
        PU2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu3(&mut self) -> PU3_W<PUCRB_SPEC> {
        PU3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu4(&mut self) -> PU4_W<PUCRB_SPEC> {
        PU4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu5(&mut self) -> PU5_W<PUCRB_SPEC> {
        PU5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu6(&mut self) -> PU6_W<PUCRB_SPEC> {
        PU6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu7(&mut self) -> PU7_W<PUCRB_SPEC> {
        PU7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu8(&mut self) -> PU8_W<PUCRB_SPEC> {
        PU8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu9(&mut self) -> PU9_W<PUCRB_SPEC> {
        PU9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu10(&mut self) -> PU10_W<PUCRB_SPEC> {
        PU10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu11(&mut self) -> PU11_W<PUCRB_SPEC> {
        PU11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu12(&mut self) -> PU12_W<PUCRB_SPEC> {
        PU12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu13(&mut self) -> PU13_W<PUCRB_SPEC> {
        PU13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu14(&mut self) -> PU14_W<PUCRB_SPEC> {
        PU14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Port B pull-up bit y (y=0..15)"]
    #[inline(always)]
    #[must_use]
    pub fn pu15(&mut self) -> PU15_W<PUCRB_SPEC> {
        PU15_W::new(self, 15)
    }
