...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wp1(&mut self) -> WP1_W<CR4_SPEC> {
        WP1_W::new(self, 0)
    }
    #[doc = "Bit 1 - Wakeup pin WKUP2 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wp2(&mut self) -> WP2_W<CR4_SPEC> {
        WP2_W::new(self, 1)
    }
    #[doc = "Bit 2 - Wakeup pin WKUP3 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wp3(&mut self) -> WP3_W<CR4_SPEC> {
        WP3_W::new(self, 2)
    }
    #[doc = "Bit 3 - Wakeup pin WKUP4 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wp4(&mut self) -> WP4_W<CR4_SPEC> {
        WP4_W::new(self, 3)
    }
    #[doc = "Bit 4 - Wakeup pin WKUP5 polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wp5(&mut self) -> WP5_W<CR4_SPEC> {
        WP5_W::new(self, 4)
    }
    #[doc = "Bit 5 - WKUP6 wakeup pin polarity"]
    #[inline(always)]
    #[must_use]
    pub fn wp6(&mut self) -> WP6_W<CR4_SPEC> {
        WP6_W::new(self, 5)
    }
    #[doc = "Bit 8 - VBAT battery charging enable"]
    #[inline(always)]
    #[must_use]
    pub fn vbe(&mut self) -> VBE_W<CR4_SPEC> {
        VBE_W::new(self, 8)
    }
    #[doc = "Bit 9 - VBAT battery charging resistor selection"]
    #[inline(always)]
    #[must_use]
    pub fn vbrs(&mut self) -> VBRS_W<CR4_SPEC> {
        VBRS_W::new(self, 9)
    }
