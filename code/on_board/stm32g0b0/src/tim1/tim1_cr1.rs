...
pub type R = crate::R<TIM1_CR1_SPEC>;
#[doc = "Register `TIM1_CR1` writer"]
pub type W = crate::W<TIM1_CR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CEN_W<TIM1_CR1_SPEC> {
        CEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Update disable This bit is set and cleared by software to enable/disable UEV event generation. Counter overflow/underflow Setting the UG bit Update generation through the slave mode controller Buffered registers are then loaded with their preload values."]
    #[inline(always)]
    #[must_use]
    pub fn udis(&mut self) -> UDIS_W<TIM1_CR1_SPEC> {
        UDIS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Update request source This bit is set and cleared by software to select the UEV event sources. Counter overflow/underflow Setting the UG bit Update generation through the slave mode controller"]
    #[inline(always)]
    #[must_use]
    pub fn urs(&mut self) -> URS_W<TIM1_CR1_SPEC> {
        URS_W::new(self, 2)
    }
    #[doc = "Bit 3 - One pulse mode"]
    #[inline(always)]
    #[must_use]
    pub fn opm(&mut self) -> OPM_W<TIM1_CR1_SPEC> {
        OPM_W::new(self, 3)
    }
    #[doc = "Bit 4 - Direction Note: This bit is read only when the timer is configured in Center-aligned mode or Encoder mode."]
    #[inline(always)]
    #[must_use]
    pub fn dir(&mut self) -> DIR_W<TIM1_CR1_SPEC> {
        DIR_W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Center-aligned mode selection Note: Switch from edge-aligned mode to center-aligned mode as long as the counter is enabled (CEN=1) is not allowed"]
    #[inline(always)]
    #[must_use]
    pub fn cms(&mut self) -> CMS_W<TIM1_CR1_SPEC> {
        CMS_W::new(self, 5)
    }
    #[doc = "Bit 7 - Auto-reload preload enable"]
    #[inline(always)]
    #[must_use]
    pub fn arpe(&mut self) -> ARPE_W<TIM1_CR1_SPEC> {
        ARPE_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (ETR, TIx): Note: tDTS = 1/fDTS, tCK_INT = 1/fCK_INT."]
    #[inline(always)]
    #[must_use]
    pub fn ckd(&mut self) -> CKD_W<TIM1_CR1_SPEC> {
        CKD_W::new(self, 8)
    }
    #[doc = "Bit 11 - UIF status bit remapping"]
    #[inline(always)]
    #[must_use]
    pub fn uifremap(&mut self) -> UIFREMAP_W<TIM1_CR1_SPEC> {
