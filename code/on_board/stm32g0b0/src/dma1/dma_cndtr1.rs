...
pub type R = crate::R<DMA_CNDTR1_SPEC>;
#[doc = "Register `DMA_CNDTR1` writer"]
pub type W = crate::W<DMA_CNDTR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndt(&mut self) -> NDT_W<DMA_CNDTR1_SPEC> {
        NDT_W::new(self, 0)
    }
...
pub struct DMA_CNDTR1_SPEC;
impl crate::RegisterSpec for DMA_CNDTR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cndtr1::R`](R) reader structure"]
impl crate::Readable for DMA_CNDTR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`dma_cndtr1::W`](W) writer structure"]
impl crate::Writable for DMA_CNDTR1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CNDTR1 to value 0"]
impl crate::Resettable for DMA_CNDTR1_SPEC {
