...
pub type R = crate::R<DMA_CNDTR4_SPEC>;
#[doc = "Register `DMA_CNDTR4` writer"]
pub type W = crate::W<DMA_CNDTR4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndt(&mut self) -> NDT_W<DMA_CNDTR4_SPEC> {
        NDT_W::new(self, 0)
    }
...
pub struct DMA_CNDTR4_SPEC;
impl crate::RegisterSpec for DMA_CNDTR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dma_cndtr4::R`](R) reader structure"]
impl crate::Readable for DMA_CNDTR4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`dma_cndtr4::W`](W) writer structure"]
impl crate::Writable for DMA_CNDTR4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMA_CNDTR4 to value 0"]
impl crate::Resettable for DMA_CNDTR4_SPEC {
